...
[![](figures/r-packages/plhdbR.jpg)](https://github.com/camposfa/plhdbR)

<br>
<hr>
<br>

[plhdbR <i class="fa fa-github"></i>](https://github.com/camposfa/plhdbR) is a collection of tools to work with data from the [Primate Life History Database](https://plhdb.org/) (PLHDB).
